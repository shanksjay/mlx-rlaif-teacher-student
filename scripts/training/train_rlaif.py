...
class CodeDataset(Dataset):
    ...
    def __getitem__(self, idx):
        ...
        # OPTIMIZATION: Removed redundant tokenization.
        # RLAIF generation (MLX/PyTorch) re-tokenizes the prompt + response anyway.
        # Tokenizing here only wastes CPU cycles and blocks the training loop.
